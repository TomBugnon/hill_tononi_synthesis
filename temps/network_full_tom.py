...
def get_Connections(params):
    ...
    # Tom TODO: In paper higher prob for cc than for ccx
    for conn in [{"sources": {"model": "L23_inh"}, "targets": {"model": "L23_exc"}},
                 #{"sources": {"model": "L23_inh"}, "targets": {"model": "L23_inh"}},  #original
    ...
    #Tom TODO: Doesn't respect text of paper, which states 1/2 of terminal to similar orientationm remaining half split between different orientations
    #! Cortico-cortical, same orientation
    ...
    #Tom TODO: This is actually counted twice instead of once///
