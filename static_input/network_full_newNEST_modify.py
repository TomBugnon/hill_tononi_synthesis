...
#        "spike_duration": 1.0,
    ...
    models = [
        ...
        #(nrnmod, 'Rp', thalamic),
        #Tom: Annoyingly, the poisson_generator model doesn't support recordables. Therefore I use sinusoidal poisson generator
        #with null amplitude
        ('sinusoidal_poisson_generator', 'Retina', {'individual_spike_trains': True, #Irrelevant if single output
                                                    'amplitude': 0.,
                                                    'rate': 0.,
                                                    'phase': 0.0})
...
def get_Connections(params):
    ...
    for conn in [#{"sources": {"model": "L23_exc"}, "targets": {"model": "L23_exc"}, "synapse_model": "NMDA_syn"}, #original
                 {"sources": {"model": "L23_exc"}, "targets": {"model": "L23_exc"}, "synapse_model": "NMDA_syn", "weights": 1.5*weight_gain}, # keiko
    ...
    for conn in [{"sources": {"model": "L23_inh"}, "targets": {"model": "L23_exc"}},
                 #{"sources": {"model": "L23_inh"}, "targets": {"model": "L23_inh"}},  #original
                 {"sources": {"model": "L23_inh"}, "targets": {"model": "L23_inh"}, "weights": 1 * weight_gain},  # keiko
                 {"sources": {"model": "L4_inh" }, "targets": {"model": "L4_exc" }},
                 #{"sources": {"model": "L4_inh"}, "targets": {"model": "L4_inh"}},  #original
                 {"sources": {"model": "L4_inh"}, "targets": {"model": "L4_inh"}, "weights": 1 * weight_gain },  # keiko
                 {"sources": {"model": "L56_inh"}, "targets": {"model": "L56_exc"}},
                 #{"sources": {"model": "L56_inh"}, "targets": {"model": "L56_inh"}}]:  #original
                 {"sources": {"model": "L56_inh"}, "targets": {"model": "L56_inh" }, "weights": 1 * weight_gain}]: # keiko
        ndict = Vp_intracortical_inhibitory_base.copy()
        ndict.update(conn)
        ccConnections.append(ndict)
    ...
    for conn in [{"sources": {"model": "L23_inh"}, "targets": {"model": "L23_exc"}},
                 # {"sources": {"model": "L23_inh"}, "targets": {"model": "L23_inh"}},  #original
                 {"sources": {"model": "L23_inh"}, "targets": {"model": "L23_inh"}, "weights": .3 * weight_gain},
                 # keiko
                 {"sources": {"model": "L4_inh"}, "targets": {"model": "L4_exc"}},
                 # {"sources": {"model": "L4_inh"}, "targets": {"model": "L4_inh"}},  #original
                 {"sources": {"model": "L4_inh"}, "targets": {"model": "L4_inh"}, "weights": 0.3 * weight_gain},
                 # keiko
                 {"sources": {"model": "L56_inh"}, "targets": {"model": "L56_exc"}},
                 # {"sources": {"model": "L56_inh"}, "targets": {"model": "L56_inh"}}]:  #original
                 {"sources": {"model": "L56_inh"}, "targets": {"model": "L56_inh"}, "weights": 0.3 * weight_gain}]:  # keiko
        ndict = Vp_intracortical_inhibitory_base.copy()
        ndict.update(conn)
        ccxConnections.append(ndict)
